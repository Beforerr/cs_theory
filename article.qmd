...
|      | Harris Current Sheet                              | Yoon-Lui Current Sheet                               | Kan Current Sheet                        |
|-------------------|-------------------------------------------------------|--------------------------------------------------------|-----------------------------------------------------|
| **Magnetic Field** | $B_x(z) = B_0 \tanh(z/L)$ | $B_x(z) = B_0 \tanh \left(\frac{h}{L} \tan^{-1}(z/h)\right)$|$B_x^*(x^*, z^*)$ |
| **Number Density** | $n(z) = n_0 \text{sech}^2(z/L)$ | $n(z) = n_0 \text{sech}^2 \left(\frac{h}{L} \tan^{-1}(z/h)\right)$ | $n^*(x^*, z^*)$ |
| **Current Density** | $j_y(z) = B_0 \text{sech}^2(z/L) / (\mu_0 L)$ |$j_y(z) = \frac{B_0}{\mu_0 L} \frac{h^2}{z^2 + h^2} \text{sech}^2 \left(\frac{h}{L} \tan^{-1}(z/h)\right)$|                     |
| **Drift Velocity** |  |$V_y(z) = V_0 \frac{h^2}{(z^2 + h^2)}$ |                                       |
| **Special Feature** | Vlasov equilibrium, Maxwellian velocity distribution | Velocity shear important for thin current sheets       | Function form involves complex variables            |
