...
$C_1=0$ immediately implies $θ = θ_1 + k \pi$ and $Λ_x=Λ_y$. This provides another equation for the system, now with force-free condition, we have 3*2+2+2=10 equations for 10 unknowns. The system is fully determined.
