...
+----------------------+--------------------------------------------------------------+------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+
|                      | Harris current sheet                                         | Yoon-Lui current sheet                                                                                     | Steinhauer current sheet (symmetric case)                                                                                            | Force-free current sheet                                                                               |
+======================+==============================================================+============================================================================================================+======================================================================================================================================+========================================================================================================+
| **Magnetic Field**   | $B_x(z) = B_0 \tanh(z/L)$                                    | $B_x(z) = B_0 \tanh \left(\frac{h}{L} \tan^{-1}(z/h)\right)$                                               | $B_x^2 = 1 + β_i(1 - n^γ) + β_e(1 - n) + 2B_z^2(1 - 1/n)$                                                                            | $B_x(z) = B_0 \sin \left(\kappa  L B_z \tan ^{-1}\left(\frac{z}{L}\right)\right)$                      |
|                      |                                                              |                                                                                                            |                                                                                                                                      |                                                                                                        |
|                      |                                                              |                                                                                                            |                                                                                                                                      | $B_y(z) = B_0 \cos \left(\kappa  L B_z \tan ^{-1}\left(\frac{z}{L}\right)\right)$                      |
+----------------------+--------------------------------------------------------------+------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+
| **Number Density**   | $n(z) = n_0 \text{sech}^2(z/L)$                              | $n(z) = n_0 \text{sech}^2 \left(\frac{h}{L} \tan^{-1}(z/h)\right)$                                         |                                                                                                                                      | $n(z) = n_\inf \left(1 + \frac{\kappa ∑_α Γ_α}{1+(z/L)^2}\right)$                                      |
+----------------------+--------------------------------------------------------------+------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+
| **Current Density**  | $J_y(z) = \frac{B_0}{\mu_0 L} \mathop{\mathrm{sech}}^2(z/L)$ | $J_y(z) = \frac{B_0}{\mu_0 L} \frac{h^2}{z^2 + h^2} \text{sech}^2 \left(\frac{h}{L} \tan^{-1}(z/h)\right)$ |                                                                                                                                      | $J_x(z) = \frac{\kappa B_0}{1+(z/L)^2} \sin \left(\kappa  L \tan ^{-1}\left(\frac{z}{L}\right)\right)$ |
|                      |                                                              |                                                                                                            |                                                                                                                                      |                                                                                                        |
|                      |                                                              |                                                                                                            |                                                                                                                                      | $J_y(z) = \frac{\kappa B_0}{1+(z/L)^2} \cos \left(\kappa  L \tan ^{-1}\left(\frac{z}{L}\right)\right)$ |
+----------------------+--------------------------------------------------------------+------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+
...
|                      |                                                              |                                                                                                            |                                                                                                                                      |                                                                                                        |
|                      | -   uniform cross-tail drift velocity                        | -   non-vanishing asymptotic particle density                                                              | -   non-analytical solution                                                                                                          | -   non-zero normal field                                                                              |
|                      |                                                              |                                                                                                            |                                                                                                                                      |                                                                                                        |
|                      |                                                              | -   Velocity shear important for thin current sheets                                                       | -   non-zero normal field                                                                                                            |                                                                                                        |
|                      |                                                              |                                                                                                            |                                                                                                                                      |                                                                                                        |
|                      |                                                              | -   Based on drift velocity profile                                                                        |                                                                                                                                      |                                                                                                        |
+----------------------+--------------------------------------------------------------+------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+
